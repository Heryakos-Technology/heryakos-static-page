<template>
  ...
  <div>
    ...
    <div class="block md:hidden md:mb-64">
      <img
        class="w-11/12 md:w-11/12 md:mx-auto md:h-screen md:overflow-hidden mx-auto h-72 mt-6 rounded-xl relative text-purple-300"
        src="/herosection-service.png" alt="Service Landing Image">
      <p
        class="md:h-1/3 md:relative text-md -mt-72 pt-2 w-full text-center mx-auto  absolute font-sans font-bold bg-gradient-to-r from-[#984AF7] to-[#8523F5] bg-clip-text text-transparent">
        OUR SERVICES
      </p>
      <p class="w-full px-20 text-center p-2 absolute -mt-64 mx-auto text-xs font-extralight text-white">We offer
        cutting-edge technology solutions designed to accelerate your business growth. From stunning web experiences to
        powerful mobile applications and future-ready blockchain solutions, we provide end-to-end services tailored to
        your unique needs.</p>
    </div>
    <!-- /end of mobile size -->
    ...
    <div class="block md:hidden">
      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 ">
        <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/first-service.png"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
      ...
      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/second-service.png"
          alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
        <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/third-service.png"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/fourth-servicee.png"
          alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
        <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/fifth-service.png"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
        ...
        <p class=" mb-4 w-4/5 mx-auto">
          Leverage the power of blockchain for secure transactions, smart contracts, and decentralized applications. We
          integrate blockchain solutions tailored to your business needs, ensuring transparency and trust.
        </p>
      </div>

      <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/sixth-service.png"
          alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
    ...
    <div class="hidden lg:block md:block">
      <div class="mb-96 ">
        <img
          class="w-11/12 lg:w-11/12 md:w-11/12 md:ml-20 lg:mx-auto lg:h-screen lg:overflow-hidden ml-4 h-72 mt-6 rounded-4xl relative text-purple-300"
          src="/herosection-service.png" alt="Service Landing Image">
        <div class="-mt-64 w-64 mx-auto">
          <p
            class="lg:text-5xl lg:text-center -ml-20 text-md -mt-96 pt-2 absolute font-sans font-bold bg-gradient-to-r from-[#984AF7] to-[#8523F5] bg-clip-text text-transparent">
            OUR SERVICES
          </p>
        </div>
        <div class="w-2/3 mx-auto -mt-96">
          <p class="w-1/2 text-center p-2 absolute text-2xl ml-20 -mt-28 font-extralight text-white">We offer
    ...
    <!-- /end of desktop view -->
    <div>
      <p class="text-md lg:text-2xl mb-4 w-full font-bold text-center  ">Ready to Showcase Your Products? <a href="#"
          class="text-[#984AF7]"><u>Click here</u></a> to sign up!</p>
    </div>
  </div>
