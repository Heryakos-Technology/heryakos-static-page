<template>
  ...
  <div>
    <!-- mobile size -->
    <div class="block md:hidden md:mb-64">
      <img class="w-11/12 md:w-11/12 md:mx-auto md:h-screen md:overflow-hidden mx-auto h-72 mt-6 rounded-xl relative text-purple-300" src="/herosection-service.png" alt="Service Landing Image">
      <p class="md:h-1/3 md:relative text-md -mt-72 pt-2 w-full text-center mx-auto  absolute font-sans font-bold bg-gradient-to-r from-[#984AF7] to-[#8523F5] bg-clip-text text-transparent">
        OUR SERVICES
      </p>
      <p class="w-full px-20 text-center p-2 absolute -mt-64 mx-auto text-xs font-extralight text-white">We offer cutting-edge technology solutions designed to accelerate your business growth. From stunning web experiences to powerful mobile applications and future-ready blockchain solutions, we provide end-to-end services tailored to your unique needs.</p>
    </div>
    <!-- /end of mobile size -->

    <!-- mobile view -->
     <div class="block md:hidden">
    <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 ">
      <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/first-service.png" alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
    ...
    <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2">
      <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/second-service.png" alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
      <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
    ...
    <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
      <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/third-service.png" alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
      <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
    ...
    <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2">
      <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/fourth-servicee.png" alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
      <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
  ...
  <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
      <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px;" src="/fifth-service.png" alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full h-auto">
      <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
    ...
    <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
      <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/sixth-service.png" alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-auto">
      <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
  ...
  <div class="mb-96 ">
  <img class="w-11/12 lg:w-11/12 md:w-11/12 md:ml-20 lg:mx-auto lg:h-screen lg:overflow-hidden ml-4 h-72 mt-6 rounded-4xl relative text-purple-300" src="/herosection-service.png" alt="Service Landing Image">
  ...
  <p class="w-1/2 text-center p-2 absolute text-2xl ml-20 -mt-28 font-extralight text-white">We offer cutting-edge technology solutions designed to accelerate your business growth. From stunning web experiences to powerful mobile applications and future-ready blockchain solutions, we provide end-to-end services tailored to your unique needs.</p>
      ...
      <div class="flex px-20 md-px-10">
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] lg:w-1/2 mr-5 rounded-lg h-1/3 mx-auto mt-8 mb-10">
          <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px; height: 450px;" src="/first-service.png" alt="Static Website Development" class="mx-auto rounded-bl-2xl rounded-tr-full w-full mb-6">
        ...
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] lg:w-1/2 ml-5 rounded-lg h-1/3 mx-auto mt-8 mb-10">
          <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px; height: 450px;" src="/second-service.png" alt="Static Website Development" class="mx-auto w-full h-1/2 mb-6">
          <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center">
            Technology Consultancy
          </h2>
      ...
      <div class="flex px-20 -mt-8">
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] w-1/2 mr-5 h-1/3 rounded-lg mx-auto mt-8 mb-10">
          <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px; height: 450px;" src="/third-service.png" alt="Static Website Development" class="mx-auto w-full mb-6">
        ...
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] w-1/2 ml-5 h-1/3 rounded-lg pb-9 mx-auto mt-8 mb-10">
          <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px; height: 450px;" src="/fourth-servicee.png" alt="Static Website Development" class="mx-auto w-full mb-6">
          <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center">
            Dynamic Website Development
          </h2>
          <p class="text-lg text-center font-serif mb-2">
      ...
      <div class="flex px-20 -mt-8">
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] w-1/2 mr-5 h-1/3 rounded-lg mx-auto mt-8 mb-10">
          <img style="border-top-right-radius: 130px; border-bottom-left-radius: 130px; height: 450px;" src="/fifth-service.png" alt="Static Website Development" class="mx-auto w-full mb-6">
          <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center">
            Blockchain Integration
          </h2>
          <p class="text-lg text-center font-serif mb-2">
        ...
        <div class=" bg-gradient-to-b from-[#F7F3FE] to-[#eee6ff] w-1/2 h-1/3 ml-5 rounded-lg mx-auto mt-8 mb-10">
          <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px; height: 450px;" src="/sixth-service.png" alt="Static Website Development" class="mx-auto w-full mb-6">
          <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center">
            Cloud Computing Solutions
          </h2>
          <p class="text-lg text-center font-serif mb-2">
    ...
    <div class=" section two w-full mx-auto flex px-4 ">
      <div class="bg-[#EBD2FF] rounded-xl  w-1/2 mr-4 mx-auto shadow-lg h-72">
        ...
        <p class="text-center text-3xl font-normal font-serif w-full mx-auto mb-4 ">$ <span class="-ml-2 -mt-3">5</span></p>
      ...
      <div class="bg-[#EBD2FF] rounded-xl  w-1/2  mx-auto shadow-lg h-72">
        ...
        <p class="text-center text-3xl font-normal w-full mx-auto font-serif mb-4 -mt-5">$ <span class="-ml-2 -mt-3">50</span></p>
