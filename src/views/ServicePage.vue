  ...
  <div>
    ...
    <div class="block md:hidden">
      <div style="border-top-left-radius: 130px;"
        class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 hover-card">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/staticweb-service.jpg"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl  w-full h-64">
      ...
      <div style="border-top-left-radius: 130px;"
        class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2 hover-card">
      ...
      <div style="border-top-left-radius: 130px;"
        class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 hover-card">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/secondservice-service.png"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl  w-full h-64">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div style="border-top-left-radius: 130px;"
        class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2 hover-card">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/dynamicweb-service.jpg"
          alt="Static Website Development" class="mx-auto rounded-br-2xl rounded-tl-full w-full h-64">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div style="border-top-left-radius: 130px;"
        class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 hover-card">
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;" src="/fifth-service.png"
          alt="Static Website Development" class="mx-auto rounded-bl-2xl  w-full h-64">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
      ...
      <div style="border-top-left-radius: 130px;"
        ...
        <img style="border-top-left-radius: 130px; border-bottom-right-radius: 130px;"
          src="/cloudcoumputing-service.jpg" alt="Static Website Development"
          class="mx-auto rounded-br-2xl rounded-tl-full w-full h-64">
        <h2 class="text-2xl md:text-3xl font-normal mb-4 text-center mt-4">
