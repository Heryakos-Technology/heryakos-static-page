<template>
  ...
  <div>
    ...
    <div class="block md:hidden">
      <div style="border-top-right-radius: 130px;" class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10 ">
      ...
      <div style="border-top-left-radius: 130px;" class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-2">
      ...
      <div style="border-top-left-radius: 130px;" class=" bg-gradient-to-b from-[#eeecf1] to-[#d09aff90] shadow-lg md:p-8 w-11/12 pb-2 rounded-lg mx-auto mt-8 mb-10">
...
<div class="hidden lg:block md:block">
    <div class="md:mb-64 lg:ml-44 md:-ml-96 max-w-screen">
      <div class="lg:ml-24 md:-ml-40">
        <img 
            class="pt-32 md:w-96  ml-88  relative text-purple-300 animated-image intro-image"
