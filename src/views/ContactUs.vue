...
<template>
    <div class="mb-20 lg:w-3/5 lg:mx-auto  md:w-4/5 md:mx-auto">
        ...
        <div class="mt-8 ">
            <h1 class="text-center text-4xl lg:text-5xl">Need a reply fast?</h1>
            <h1 class="text-center text-6xl mt-12">Let's <span class="talk">talk!</span> </h1>
            <p class="text-2xl  mt-10 font-light w-5/6 mx-auto leading-9 lg:w-2/3 lg:mx-auto md:w-120 md:mx-auto">Share
                your project requirements
                here or send us an email at
                info@orizon.com we will follow up
                in <span class="font-bold">24 hrs</span> </p>
        </div>
        <div class="ml-8 mt-10 text-3xl font-light lg:mx-auto md:mx-auto">
            <div>
                <div class="">
                ...
                <div class="mt-4">
                    <input type="text" placeholder="Don from Earth,Inc."
                        class="input border focus:outline-none w-13/14 border-pink-200 py-6 pl-6 rounded-xl placeholder:text-black placeholder:text-2xl lg:w-7/8">
                </div>
            </div>
                    ...
                    <div class="w-3/4">
                        ...
                        <div class="mt-4 ">
                            <input type="text" placeholder="don@norman.me"
                                class="input border focus:outline-none   border-pink-200 py-6 pl-6 rounded-xl placeholder:text-black placeholder:text-2xl w-3/4">
                        </div>
                    </div>
                    <div class="w-3/4">
                        <div class="">
            ...
            <div class="mt-16 lg:hidden">
                ...
                <div class="mt-4">
                    <input type="text" placeholder="don@norman.me"
                        class="input border focus:outline-none w-13/14 border-pink-200 py-6 pl-6 rounded-xl placeholder:text-black placeholder:text-2xl">
                </div>
            </div>
            <div class="mt-16 lg:hidden">
                <div>
            ...
            <div class="mt-16">
                ...
                <div class="mt-4 lg:hidden">
                    <textarea cols="24" rows="6" type="text"
                        ...
                        class="input border focus:outline-none  border-pink-200 py-6 w-13/14 pl-6 pr-2 pt-12 pb-1 rounded-xl placeholder:text-black placeholder:text-2xl "
                        style="white-space: pre-line;" />
                </div>
                <div class="mt-4 hidden lg:block">
                    <textarea cols="49" rows="5" type="text"
                        placeholder="We need to launch Earth’s new UI and improve usability on key user flows such as climate, health and orbital escape velocity..."
                        class="input border focus:outline-none border-pink-200 py-6 pl-6 pr-2 lg:pt-16 lg:w-7/8 lg:pb-0 pt-12 pb-1 rounded-xl placeholder:text-black placeholder:text-2xl "
                        style="white-space: pre-line;" />
                </div>
            </div>
            <div class="mt-16">
                ...
                <div class="mt-4">
                    <input type="text" placeholder="enter your subject here."
                        class="input border w-13/14 border-pink-200 py-6 pl-6 rounded-xl focus:outline-none placeholder:text-black placeholder:text-2xl lg:w-7/8">
                </div>
            </div>
            <div class="mt-16 ml-40  justify-end">
                <button
                    class="button text-white py-2 px-5 w-10/11 -ml-3   rounded-lg text-2xl lg:rounded-3xl lg:text-lg lg:px-8 lg:ml-40 lg:w-1/2">Send
                    Message</button>
        ...
        <div class="hidden lg:block text-white  bg-black mt-20 pr-10 pl-16 rounded-full pb-10 pt-5  ">
            <div class="flex">
                <div>
                    <img src="/groupImageBottom.png" alt="">
                </div>
        ...
        <div class="mt-28 ">
            <div class="flex ml-1 mr-1">
                <div
                    class="flex cardDiv pl-3 pr-3 w-3/4 rounded-lg pt-3 pb-6 shadow-md lg:w-4/5 lg:mr-5 lg:pl-10 lg:pt-6">
                    <div class="mr-2">
                ...
                <div
                    class="flex cardDiv w-3/4 pl-3 pr-3 rounded-lg py-4 ml-3 lg:w-3/4 lg:h-48 lg:mr-5 lg:pl-10 lg:pt-6">
                    <div class="mr-2">
            ...
            <div
                class="flex cardDiv w-1/2 pl-3 pr-2  rounded-lg pt-3 pb-7 ml-1 shadow-md mt-10 lg:h-48  lg:pr-1 lg:pl-10  lg:pt-6 lg:w-98">
                <div class="mr-2">
