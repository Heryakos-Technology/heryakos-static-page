...
<template>
    ...
    <div class=" mb-1 lg:w-1/2 lg:mx-auto lg:pt-50">
        <div>
            <img src="/team_photo1.png" alt=""
                class="h-50  w-4/5  ml-19 md:w-3/4 md:ml-48 md:h-60 relative lg:w-3/4  lg:h-115 " />
        </div>
        <div
            class="bg-white absolute w-11/12 md:w-3/4 md:h-60 md:mx-auto md:left-6 mx-auto py-5 px-4 top-30 right-10 lg:top-44 lg:h-8/12 lg:w-1/3 lg:right-130">
            <div class="  lg:top-56 text-black">
                <h1 class="lg:text-xl lg:font-bold w-15/15 text-purple-700 font-bold text-sm">FINANCIAL FOCUS &
                    CONSULTING</h1>
                <h2 class="mt-3 lg:mt-8 lg:text-xl lg:font-semibold w-11/11 md:w-3/4 md:mt-8 lg:w-10/10 lg:mx-auto">
                    ...
                    comprehensive solutions Join us on this journey of discovery and knowledge, as we share
                ...
                <div class="lg:mt-20 mt-6 md:mt-14 lg:w-10/10 lg:mx-auto ">
                    <a href="#"
                        class="bg-white text-purple-800 px-5 py-2 lg:px-6 lg:py-3 mt-4 rounded-lg lg:rounded-2xl lg:text-lg  border border-purple-200">LEARN
                        MORE</a>
                    <a href="/contact"
                        class="button text-white px-5 py-2 lg:px-6 lg:py-3 mt-4 rounded-lg lg:rounded-2xl ml-4 lg:text-lg lg:ml-10">CONTACT
                        US</a>
                </div>
            </div>
        </div>
        ...
        <div class=" middleContainer  lg:w-64 w-10/11 mx-auto ml-4 mt-50 rounded-md shadow-sm md:w-12/12  md:mx-auto">
            <div class="pl-4 pt-6 pb-5 lg:mt-5 lg:ml-10 md:w-3/4">
                ...
                <h2 class="mt-5 text-sm w-80 lg:w-2/3 lg:text-lg md:w-100 md:ml-10 ">
                    We are a passionate team dedicated to providing high-quality content and resources that inspire and
                    inform our audience. With a focus on innovation and creativity, we strive to deliver engaging
                    experiences that resonate with our visitors. Our mission is to connect, educate, and empower
                    individuals through our carefully curated articles and insights.
                </h2>
    ...
    <div class="hidden lg:block lg:visible lg:w-3/4 ">
        ...
        <div
            class="middleContainer  mt-20 rounded-md md:ml-28  shadow-sm flex lg:justify-between ml-3 mr-3 lg:ml-44 lg:mr-32 md:w-full">
            ...
            <div class=" lg:w-full">
                <img src="/teamsmall2.png" alt="" class="h-full rounded-md lg:hidden" />
                <img src="/teamlarge2.jpg" alt=""
                    class="h-full w-full rounded-md hidden lg:block lg:visible lg:h-full lg:w-full lg:rounded-xl" />
            </div>
        </div>
    </div>
    ...
    <div
        class="lastContainer mt-10 rounded-sm shadow-sm pb-5 ml-4 mr-3 lg:ml-44 lg:mr-32 lg:pl-10 lg:pr-10  lg:mt-20  lg:mb-12 md:mb-10 lg:w-3/4 w-10/11 mx-auto mb-10 md:w-9/11 md:mx-auto md:pl-6">
        ...
        <div class="flex ml-6 mr-6 mt-6 lg:justify-between lg:ml-10  mx-auto lg:mr-10 md:mx-14 md:w-10/11 lg:mt-10">
            <TeamCard name="Victor Vivas" role="UI/UX Designer" imgSrc="/Victor.jpg"
                :class="['box', { animate: isAnimating }]" class=" lg:mr-20 mr-4 w-1/4" />
            <TeamCard name="Pedro Sanin" role="Manager Partner" imgSrc="/PedroMale.jpg" class="box1 w-1/4" />
        </div>
        <div class="flex ml-6 mr-6 mt-16 lg:justify-between lg:ml-10 lg:mr-10  md:mx-14 md:w-10/11 lg:mt-20 ">
            <TeamCard name="Maria José Jimenez" role="Architect" imgSrc="/MariaMale.jpg"
                class="box3 lg:mr-20 mr-4 w-1/4" />
            <TeamCard name="Maria José Jimenez" role="Manager Partner" imgSrc="/MariaFemale.jpg" class="box3 w-1/4" />
        </div>
        <div class="flex ml-6 mr-6 mt-16 lg:justify-between lg:ml-10 lg:mr-10 md:mx-14 md:w-10/11 lg:mt-20">
            <TeamCard name="Maria José Jimenez" role="UI/UX Designer" imgSrc="/MariaFemaleWithTablate.jpg"
                class="box lg:mr-20 mr-4 w-1/4" />
            <TeamCard name="Pedro Sanin" role="Manager Partner" imgSrc="/PedroFemale.jpg" class="box1 w-1/4" />
        </div>
    </div>
