    ...
    <div class="lg:px-20 md:mb-20 lg:-mt-32 hidden  md:pt-24 md:block">
        ...
        <div class="lg:-mt-40 lg:ml-36 ">
            <div class="w-11/12 h-44 md:ml-20 md:w-4/5 bg-white absolute -mt-14 lg:w-1/3 lg:h-96 lg:-mt-96">
                <p
                    class=" text-sm w-96 pt-5 pl-5 pr-4 md:text-lg md:w-11/12  lg:text-2xl lg:w-11/12 lg:mx-auto lg:mt-6">
        ...
        <div class="flex ">
            <div class="bg-[#ece3ff] w-1/2 md:w-1/2 mx-auto mt-20 pb-26 mb-10 mr-10">
                ...
                <div class="w-1/4 h-64 md:4/5 pb-6  bg-white ml-7 absolute -mt-16">
                    <p class="w-80 mx-auto mt-2  text-lg font-bold text-gray-800">The Future of Healthcare: Technology
                        Meets Compassion</p>
                    <p class="w-80 mx-auto text-md mt-2 font-semibold">August 30, 2024 <span
                            class="font-bold text-lg ml-3 mr-3">. </span> Healthcare</p>
                    <p class="w-80 mx-auto mt-3 text-md">innovations like AI and telemedicine are reshaping healthcare.
            ...
            <div class="bg-[#ece3ff] w-1/2 md:w-1/2 mx-auto mt-20 pb-26 mb-10">
                ...
                <div class="w-1/4 h-64 pb-6  bg-white ml-7 absolute -mt-16">
                    ...
                    <p class="w-80 mx-auto text-md mt-2 font-semibold">August 2, 2024 <span
                            class="font-bold text-lg ml-3 mr-3">. </span> Software</p>
                    <p class="w-80 mx-auto mt-3 text-md">Explore the dynamic world of web and mobile development, where
        ...
        <div class="flex ">
            <div class="bg-[#ece3ff] w-11/12 mx-auto mt-20 pb-26 mb-10 mr-10">
                ...
                <div class="w-1/4 h-64 pb-6  bg-white ml-8 absolute -mt-16">
                    <p class="w-80 mx-auto mt-2  text-lg font-bold text-gray-800">Cloud Technology Revolutionizing
                        Business in 2025</p>
                    <p class="w-80 mx-auto text-md mt-2 font-semibold">january 30, 2025 <span
                            class="font-bold text-lg ml-3 mr-3">. </span> Technology</p>
                    <p class="w-80 mx-auto mt-3 text-md">Cloud technology is reshaping the business landscape in 2025 by
            ...
            <div class="bg-[#ece3ff] w-11/12 mx-auto mt-20 pb-26 mb-10">
                ...
                <div class="w-1/4 h-64 pb-6  bg-white ml-7.5 absolute -mt-16">
                    <p class="w-80 mx-auto mt-2  text-lg font-bold text-gray-800">Enhancing Business Operations Through
                        Online Platforms</p>
                    <p class="w-80 mx-auto text-md mt-2 font-semibold">march 2, 2025 <span
                            class="font-bold text-lg ml-3 mr-3">. </span> Business</p>
                    <p class="w-80 mx-auto mt-3 text-md">Business companies are increasingly leveraging online platforms
